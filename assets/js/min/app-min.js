(function () {
	...
	var panelsnap_umd = createCommonjsModule(function (module, exports) {
	/**
	 * PanelSnap.js v1.3.0
...
`;
	...
	player.on("play", function () {
	  jquery("[data-src]").removeClass("playing audio-active");
	  jquery("[data-src='" + getRelativePlayerSource() + "']").addClass("playing  audio-active");
	});

	player.on("pause", function () {
	  jquery("[data-src]").removeClass("playing");
	});
	...
	jquery(".home").on("click", ".plyr__control.next-audio-item", function () {
	  ...
	  var activeIndex = $allSources.index(jquery(".audio-active[data-src]"));
	...
	jquery(".home").on("click", ".plyr__control.prev-audio-item", function () {
	  var $allSources = jquery("[data-src]");
	  var activeIndex = $allSources.index(jquery(".audio-active[data-src]"));
	...
	playSrc(jquery("[data-src]:first").data("src"), jquery("[data-src]:first"), true);
